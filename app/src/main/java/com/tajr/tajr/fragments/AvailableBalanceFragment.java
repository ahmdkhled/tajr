...
import com.tajr.tajr.view.utils.AnimatedExpandableListView;
 ...
 */
public class AvailableBalanceFragment extends Fragment {
    ...
    public AvailableBalanceFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_available_balance, container, false);
    }
        ...
        api.getMoneyHistory(
            ...
            public void onResponse(Call<MoneyHistory> call, Response<MoneyHistory> response) {
                ...
                if (response.body() != null&&response.body().getHistory()!=null) {
                    ...
                    GroupItem item = null;
                    for (MoneyHistory.Year year : years) {
                        item = new GroupItem();
                        item.year = year.getYear();
                        ChildItem child;
                        for (MoneyHistory.Year.Month month : year.getMonth()) {
                            child = new ChildItem();
            ...
            @Override
            public void onFailure(Call<MoneyHistory> call, Throwable t) {
